          ...
          <div class="row d-flex align-items-stretch">
			...
			<!-- 1번째 글 -->
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b>김태영</b></h2>
                      <p class="text-sm"><b>ID:</b>&nbsp;<input type="hidden">S001 <br>   
                     <b>회원등급:</b>&nbsp; <input type="hidden">일반 </p>               
                      <ul class="ml-4 mb-0 fa-ul text-muted">
                      <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> 전화번호:&nbsp; + 800
                         <input type="hidden">010-0000-0001</li>
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> 주소:&nbsp;
                    ...
                    <br><br>
                    <p class="text-sm"><b>선생님께 한마디:</b>&nbsp;<input type="hidden">어제부터 배가 아파요<br>
      		        <b>진료기록물 신청:</b>&nbsp;<input type="hidden">없음<br>
      		        <b>진료신청 일시:</b>&nbsp;<input type="hidden">2020-02-10 </p>
                  </div>
                </div>
              </div>
            </div>
